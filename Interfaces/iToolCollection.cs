...
namespace Assignment
{
    ...
    interface iToolCollection
    {
        ...
        void add(iTool); //add a given tool to this tool collection
        void delete(iTool); //delete a given tool from this tool collection
        Boolean search(iTool); //search a given tool in this tool collection. Return true if this tool is in the tool collection; return false otherwise
